...
//                .getString(miheadset_notification_Disconnect))
        ...
        fun registerHyperPodsReceiver(context: Context) {
            ...
            val filter = IntentFilter("chen.action.hyperpods.sendstrongtoast").apply {
                addAction("chen.action.hyperpods.updatepodsnotification")
        ...
        // context. appContext can still be null when LSPosed first enters OS4.
        ...
        // HyperOS 4 has its own AirPods fast-connect pipeline. It consumes Apple
